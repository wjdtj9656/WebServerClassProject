...
%>
    ...
    %>
                <TR ALIGN="LEFT">
                    ...
                    <TD WIDTH="10%" ALIGN="CENTER">
                      <% url="Quiz_remove.jsp?quiz_Table=quiz_obj&number=" + number; %>
    ...
    <% 
            try{ 
                sql = "SELECT * FROM " + tableName_short;
                sql = sql + "	ORDER BY quiz_id ASC;";
                result = stmt.executeQuery( sql );
    ...
    %>
            <TR ALIGN="LEFT">
                ...
                <TD WIDTH="10%" ALIGN="CENTER">
                  <% url="Quiz_remove.jsp?quiz_Table=quiz_short&number=" + number; %>
                  <input type="button" value="delete" onclick="document.location.href='<%=url%>'">
    ...
    <%		
        }catch(Exception e){System.out.println("��ũ�� �ְ��� " + e.toString());};
    %>
        <TR>
            ...
            <TR ALIGN="CENTER">
                <TD COLSPAN="3" ALIGN="CENTER" >
                        ...
                        <input type="button" value="New Quiz" onclick="document.location.href='quizBoard.jsp'">
                        &nbsp;&nbsp;&nbsp;
                        <input type="button" value="Tests"onclick="document.location.href='Quiz_package.jsp'">
