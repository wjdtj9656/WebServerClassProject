...
String new_quiz_short_ans = request.getParameter("new_quiz_short_ans");
    ...
    try{
		if( new_quiz_obj != null && new_quiz_obj_ans.length > 0 && new_quiz_obj_check > 0 
			&& !new_quiz_obj.equals("") ){
			sql = "INSERT INTO " + table_obj + "(quiz_obj, quiz_obj_ans1, quiz_obj_ans2, quiz_obj_ans3, quiz_obj_ans4) VALUES ('  ";
    ...
    try{
		if( new_quiz_short != null && new_quiz_short_ans != null && !new_quiz_short.equals("")
            ...
            sql = "INSERT INTO " + table_short + "(quiz_short, quiz_short_ans) VALUES ('      ";
    ...
    stmt = null;
    conn = null;
	response.sendRedirect("quizBoard.jsp");
%>